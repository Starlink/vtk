/*=========================================================================
  ...
  Module:    $RCSfile: vtkFactoredArrayDataAlgorithm.h,v $
...
private:
  vtkFactoredArrayDataAlgorithm(const vtkFactoredArrayDataAlgorithm&);  // Not implemented.
  void operator=(const vtkFactoredArrayDataAlgorithm&);  // Not implemented.
};
